...
\definecolor{layer1}{RGB}{44,102,146}
\definecolor{layer2}{RGB}{34,139,96}
\definecolor{layer3}{RGB}{201,111,29}
\definecolor{layer4}{RGB}{153,102,204}

% Pyramid layers (bottom to top, widest to narrowest)
\fill[layer1!20, draw=layer1!60, line width=0.8pt, rounded corners=2pt]
  (-5.0, 0) -- (5.0, 0) -- (4.0, 1.6) -- (-4.0, 1.6) -- cycle;
\fill[layer2!20, draw=layer2!60, line width=0.8pt, rounded corners=2pt]
  (-4.0, 1.8) -- (4.0, 1.8) -- (3.0, 3.4) -- (-3.0, 3.4) -- cycle;
\fill[layer3!20, draw=layer3!60, line width=0.8pt, rounded corners=2pt]
  (-3.0, 3.6) -- (3.0, 3.6) -- (2.0, 5.2) -- (-2.0, 5.2) -- cycle;
\fill[layer4!20, draw=layer4!60, line width=0.8pt, rounded corners=2pt]
  (-2.0, 5.4) -- (2.0, 5.4) -- (1.2, 6.8) -- (-1.2, 6.8) -- cycle;

% Layer labels (centered in each trapezoid)
\node[font=\small\bfseries, text=layer1!80!black] at (0, 0.8)
  {Layer 1: Infrastructure \& Hardware Selection};
\node[font=\small\bfseries, text=layer2!80!black] at (0, 2.6)
  {Layer 2: Model Compression \& Quantization};
\node[font=\small\bfseries, text=layer3!80!black] at (0, 4.4)
  {Layer 3: Inference Engine Optimization};
\node[font=\small\bfseries, text=layer4!80!black] at (0, 6.1)
  {Layer 4: Application-Level};

% Annotations (right side)
\node[anchor=west, text width=4.5cm, font=\footnotesize, text=layer1!70!black]
  at (5.3, 0.8) {GPU/TPU selection, cloud instance sizing, multi-GPU topology};
\node[anchor=west, text width=4.5cm, font=\footnotesize, text=layer2!70!black]
  at (4.3, 2.6) {INT8/FP8 quantization, pruning, distillation, LoRA adapters};
\node[anchor=west, text width=4.5cm, font=\footnotesize, text=layer3!70!black]
  at (3.3, 4.4) {Kernel fusion, FlashAttention, KV-cache paging, continuous batching};
\node[anchor=west, text width=4.5cm, font=\footnotesize, text=layer4!70!black]

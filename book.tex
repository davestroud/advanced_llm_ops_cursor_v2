...
% ---------- CODE LISTINGS ----------
\usepackage{minted}      % primary code typesetting (requires -shell-escape + Pygments)
...
% ---------------------------------------------------------------
% Preview cover page. Springer Nature production replaces this
% with the final printed cover; this is a draft-only asset.
% Remove or comment out before final manuscript submission.
% ---------------------------------------------------------------
\begin{titlepage}
  \thispagestyle{empty}
  \centering

...
\midrule
LLM Inference & 55\% & \$4{,}400 & Quantization, KV-cache optimization, prompt compression, model routing \\
...
Monitoring / observability & 5\% & \$400 & Sampling strategies, log retention policies, metric aggregation \\
\bottomrule
\end{tabularx}
\end{table}

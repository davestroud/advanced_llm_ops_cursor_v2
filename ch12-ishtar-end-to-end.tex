...
\end{tikzpicture}
\end{llmfigbox}
\caption{Evolution of key \ishtar{} metrics across deployment phases. Latency (left axis, blue) decreases as infrastructure optimizations and autoscaling are introduced; accuracy (right axis, red) increases as RAG, evaluation gates, and monitoring drive iterative quality improvements. Each deployment phase contributes measurable gains, illustrating the cumulative benefit of systematic LLMOps practices.}

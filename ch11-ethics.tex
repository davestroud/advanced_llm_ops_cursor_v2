...
\begin{lstlisting}[
  ...
  style=springerfloat,
  language=Python,
  caption={Practical bias detection pipeline that computes sentiment scores across demographic groups and flags disparities exceeding a configurable threshold.},
  label={lst:ch11_bias_detection}
]
...
\begin{lstlisting}[
  float=htbp,
  style=springerfloat,
  caption={JSON schema for LLM audit trail events. Each field supports a specific accountability or compliance requirement.},
  label={lst:ch11_audit_schema}
]
{

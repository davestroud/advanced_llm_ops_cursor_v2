...
\begin{figure}[t]
    ...
    \begin{tikzpicture}[
      ...
      box/.style={draw=none, rounded corners=5pt, minimum width=36mm, minimum height=10mm, align=center, inner sep=5pt, font=\small\bfseries}
        ...
        \node[box, fill=llmblue!15] (input) {Input (tokens)};
        \node[box, fill=llmorange!15, below=of input] (mha) {Multi-Head Attention};
        \node[box, fill=llmgreen!15, below=10mm of mha] (addnorm1) {Add \& Norm};
        \node[box, fill=llmpurple!15, below=10mm of addnorm1] (ffn) {Feed-Forward Network};
        \node[box, fill=llmgreen!15, below=10mm of ffn] (addnorm2) {Add \& Norm};
        \node[box, fill=llmblue!15, below=12mm of addnorm2] (output) {Hidden States / Next Block};

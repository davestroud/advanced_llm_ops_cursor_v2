...
\begin{figure}[t]
    ...
    \end{tikzpicture}
    \end{llmfigbox}
    \caption{Empirical growth in Transformer-based model size (log scale). Parameter counts have increased by orders of magnitude, driving distinct operational constraints in memory, compute, and cost. As shown in Figure~\ref{fig:ch02_llm_scale}, model sizes have grown from millions to hundreds of billions of parameters in just a few years.}

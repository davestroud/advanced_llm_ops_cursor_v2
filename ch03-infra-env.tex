...
% ================== SECTION HEADERS ==================
\node[header] (headerA) at (-52mm, 48mm) {Cloud-Native};
\node[header] (headerB) at (52mm, 48mm) {Hybrid};
\node[header] (headerC) at (0mm, -42mm) {Multi-Cluster / Multi-Region};

% ================== VISUAL SEPARATORS ==================
\draw[draw=black!15, line width=0.6pt, dashed] (0mm, -60mm) -- (0mm, 16mm);
\draw[draw=black!15, line width=0.6pt, dashed] (-90mm, -8mm) -- (90mm, -8mm);

% ================== (A) CLOUD-NATIVE (Top Left) ==================
\node[cloud] (cloudA) at (-52mm, 22mm) {};
...
\node[gw] (vpnL) at ($(premB.east) + (10mm, 0)$) {VPN\\Gateway};
\node[gw] (vpnR) at ($(cloudB.west) + (-10mm, 0)$) {Direct\\Connect};
...
\node[cloud, minimum width=82mm, minimum height=52mm] (cloudC) at (0mm, -65mm) {};
...
\node[vpc, minimum width=36mm, minimum height=36mm] (vpcC1) at ($(cloudC.center) + (-22mm, -6mm)$) {};
...
\node[vpc, minimum width=36mm, minimum height=36mm] (vpcC2) at ($(cloudC.center) + (22mm, -6mm)$) {};
...
\draw[arrowDashed, color=gray!65] (k8sC1) --
  node[font=\scriptsize\bfseries, align=center, midway, above, sloped, text=black!80]
  {failover} (k8sC2);

% ================== LEGEND (Bottom) ==================
\node[box, fill=white, draw=black!40, rounded corners=4pt, line width=0.8pt,
      minimum width=160mm, minimum height=10mm, inner sep=4pt] (legend)
  at (0mm, -98mm) {};
...
\node[vpc, minimum width=8mm, minimum height=6mm, inner sep=1pt] (L2) at ($(L1.east) + (16mm, 0)$) {};
\node[font=\scriptsize, right=2mm of L2.east, anchor=west] {VPC};
\node[onprem, minimum width=8mm, minimum height=6mm, inner sep=1pt] (L3) at ($(L2.east) + (14mm, 0)$) {};
\node[font=\scriptsize, right=2mm of L3.east, anchor=west] {On-Prem};
\node[k8s, minimum width=8mm, minimum height=6mm, inner sep=1pt] (L4) at ($(L3.east) + (20mm, 0)$) {};
\node[font=\scriptsize, right=2mm of L4.east, anchor=west] {K8s};
\node[gpu, minimum width=8mm, minimum height=6mm, text width=6mm, inner sep=1pt] (L5) at ($(L4.east) + (14mm, 0)$) {};
\node[font=\scriptsize, right=2mm of L5.east, anchor=west] {GPU};
\node[lb, minimum width=8mm, minimum height=6mm, text width=6mm, inner sep=1pt] (L6) at ($(L5.east) + (14mm, 0)$) {};
\node[font=\scriptsize, right=2mm of L6.east, anchor=west] {API GW};
\node[gw, minimum width=8mm, minimum height=6mm, text width=6mm, inner sep=1pt] (L7) at ($(L6.east) + (18mm, 0)$) {};
\node[font=\scriptsize, right=2mm of L7.east, anchor=west] {VPN};
\node[store, minimum width=8mm, minimum height=6mm, text width=6mm, inner sep=1pt] (L8) at ($(L7.east) + (14mm, 0)$) {};

...
\begin{tikzpicture}[
  ...
  arrow/.style={-{Latex[length=2mm]}, line width=1pt, draw=black!75},
  arrowDashed/.style={-{Latex[length=2mm]}, dashed, line width=0.8pt, draw=black!55},
...
\draw[arrow, color=llmorange!85!black] (apigwA) -- (k8sA);
\draw[arrow, color=llmpurple!85!black] (k8sA) -- (objA);
...
\draw[arrow, color=llmgreen!85!black] (k8sBprem.east) -- (vpnL.west);
\draw[arrow, color=llmgreen!85!black] (vpnR.east) -- (k8sBcloud.west);
\draw[arrowDashed, color=gray!65] (vpnL) -- (vpnR);
\draw[arrow, color=llmpurple!85!black] (k8sBprem) -- (vecB);
\draw[arrow, color=llmorange!85!black] (apigwB) -- (k8sBcloud);
...
\draw[arrow, color=llmorange!85!black] (glbC.south west) ++(2mm,0) -- (k8sC1.north);
\draw[arrow, color=llmorange!85!black] (glbC.south east) ++(-2mm,0) -- (k8sC2.north);
\draw[arrowDashed, color=gray!65] (k8sC1) --
...
\begin{figure}[tb]
  ...
  \begin{tikzpicture}[
    ...
    cloud/.style={llm/box/purple, ellipse, minimum width=30mm, minimum height=10mm, font=\scriptsize\bfseries, align=center, text width=28mm},
    ingress/.style={llm/box/blue, minimum width=34mm, minimum height=10mm, font=\scriptsize\bfseries, align=center, text width=32mm},
    security/.style={llm/box/orange, fill=llmorange!18, draw=llmorange!70, minimum width=22mm, minimum height=9mm, font=\scriptsize\bfseries, align=center, text width=20mm},
    k8s/.style={llm/box/orange, fill=llmorange!25, draw=llmorange!70, minimum width=26mm, minimum height=9mm, font=\scriptsize\bfseries, align=center},
    gpu/.style={llm/box/orange, fill=llmorange!12, draw=llmorange!50, minimum width=14mm, minimum height=8mm, font=\scriptsize, align=center},
    managed/.style={llm/box/green, fill=llmgreen!15, draw=llmgreen!70, minimum width=22mm, minimum height=8mm, font=\scriptsize, align=center, text width=20mm},
    az/.style={llm/lane, inner sep=6pt, minimum height=32mm},
    ...
    \node[llm/label, right=2mm of k8s1.south east, yshift=-6mm, font=\scriptsize\bfseries, text=llmorange!80!black] (as) {Auto\\Scale};
    \node[fit=(k8s1)(g14)(g15)(as), az, label={[font=\scriptsize\bfseries,text=llmblue!70!black]above:AZ-1}] (az1) {};
    ...
    \node[fit=(k8s2)(g21)(g22), az, label={[font=\scriptsize\bfseries,text=llmblue!70!black]above:AZ-2}] (az2) {};

    % "Private Subnets" outer lane
    \node[fit=(az1)(az2), llm/lane, inner sep=9pt, label={[font=\scriptsize\bfseries,text=llmblue!70!black]below:Private Subnets}] (priv) {};
    ...
    \node[llm/label, right=2mm of mgsbox.east, font=\scriptsize\bfseries, text=llmpurple!70!black, align=center] {DR Region\\via IaC};
    ...
    \draw[{Latex[length=2.2mm]}-{Latex[length=2.2mm]}, line width=0.8pt, color=llmorange!80!black] (g15) -- (as);

    % Legend
    \node[llm/label, below=10mm of priv.south west, anchor=north west, font=\scriptsize\bfseries] (klbl) {Key Features:};
    \node[legendsw, fill=llmorange!18, draw=llmorange!50, below=3mm of klbl.south west, anchor=north west] (le1) {};
    \node[llm/label, right=2mm of le1, font=\scriptsize] {GPU Nodes (Auto-scaling)};
    \node[legendsw, fill=llmgreen!15,  draw=llmgreen!70,  below=2mm of le1]  (le2) {};
    \node[llm/label, right=2mm of le2, font=\scriptsize] {Managed Services};
    \node[legendsw, fill=llmorange!18, draw=llmorange!70, below=2mm of le2]  (le3) {};
    \node[llm/label, right=2mm of le3, font=\scriptsize] {Security \& IAM};
  \end{tikzpicture}
  \end{llmfigbox}
...
\begin{tikzpicture}[
  ...
  gpu/.style={llm/box/purple, fill=llmpurple!18, draw=llmpurple!70, minimum width=18mm, minimum height=8mm, font=\scriptsize, align=center},
  gpuH/.style={llm/box/purple, fill=llmpurple!30, draw=llmpurple!80, minimum width=22mm, minimum height=8mm, font=\scriptsize\bfseries, align=center},
  gpuA/.style={llm/box/purple, fill=llmpurple!10, draw=llmpurple!50, minimum width=22mm, minimum height=8mm, font=\scriptsize, align=center},
  embed/.style={llm/box/orange, fill=llmorange!18, draw=llmorange!70, minimum width=30mm, minimum height=12mm, font=\scriptsize\bfseries, align=center, text width=28mm},
  iac/.style={llm/box/blue, minimum width=54mm, minimum height=10mm, font=\scriptsize\bfseries, align=center, text width=50mm},
  pods/.style={llm/box/orange, fill=llmorange!18, draw=llmorange!70, minimum width=54mm, minimum height=10mm, font=\scriptsize\bfseries, align=center, text width=50mm},
  vpn/.style={llm/box/green, fill=llmgreen!15, draw=llmgreen!70, minimum width=16mm, minimum height=9mm, font=\scriptsize\bfseries, align=center},
  ...
  \node[fit=(l41)(l42)(embed), group,
        label={[font=\scriptsize\bfseries,text=black!70]above:On-Prem (L4 Cluster)}] (onprem) {};

  % Right: AWS EKS cluster
  \node[iac,  right=30mm of l41, xshift=8mm] (tf) {Terraform + ArgoCD + K8s Autoscaling};
  \node[pods, below=3mm of tf] (pods) {Model Serving Pods (TGI / vLLM)};

  % Autoscaling node group
  \node[gpuH, below=5mm of pods.south, xshift=-14mm] (h1) {H100};
  \node[gpuH, right=4mm of h1] (h2) {H100};
  \node[llm/label, font=\scriptsize\bfseries, above=0.5mm of h1.north west, anchor=south west, xshift=-4mm] {Autoscaling Node Group};
  \node[fit=(h1)(h2), group, inner sep=5pt] (asng) {};

  % Baseline node group
  \node[gpuA, below=4mm of h1] (a1) {A100};
  \node[gpuA, right=4mm of a1]  (a2) {A100};
  \node[llm/label, font=\scriptsize, above=0.5mm of a1.north west, anchor=south west, xshift=-4mm] {Baseline Node Group};
  \node[fit=(a1)(a2), group, inner sep=5pt] (bng) {};

  \node[fit=(tf)(pods)(asng)(bng), group, inner sep=8pt,
        label={[font=\scriptsize\bfseries,text=llmblue!70!black]above:AWS EKS Cluster}] (eks) {};
  ...
  % Legend
  \node[llm/label, below=6mm of bng.south west, anchor=north west, font=\scriptsize, xshift=-40mm] (k1) {};
  \node[legendsw, fill=llmpurple!10, draw=llmpurple!50, right=0mm of k1.west] (le1) {};
  \node[llm/label, right=2mm of le1, font=\scriptsize] (le1t) {L4 / A100 GPU};
  \node[legendsw, fill=llmpurple!30, draw=llmpurple!80, right=8mm of le1t] (le2) {};
  \node[llm/label, right=2mm of le2, font=\scriptsize] (le2t) {H100 GPU};
  \node[legendsw, fill=llmorange!18, draw=llmorange!70, right=8mm of le2t] (le3) {};
  \node[llm/label, right=2mm of le3, font=\scriptsize] (le3t) {Serving Pods};
  \node[legendsw, fill=llmblue!15,   draw=llmblue!70,   right=8mm of le3t] (le4) {};
  \node[llm/label, right=2mm of le4, font=\scriptsize] {IaC / Control Plane};
\end{tikzpicture}
\end{llmfigbox}

...
\begin{tikzpicture}[
  ...
  cloud/.style={box, fill=cloudblue!15, draw=cloudblue!80!black, line width=1pt,
                minimum width=44mm, minimum height=56mm, inner sep=6pt},
  vpc/.style={box, fill=vpccyan!18, draw=vpccyan!75!black, line width=0.8pt, inner sep=5pt},
  onprem/.style={box, fill=onpremgray!15, draw=onpremgray!75!black, line width=1pt,
                 minimum width=44mm, minimum height=56mm, inner sep=6pt},
  k8s/.style={box, fill=k8sgreen!18, draw=k8sgreen!75!black, line width=0.8pt, inner sep=5pt},
  lb/.style={res, fill=apiorange!25, draw=apiorange!75!black},
  gw/.style={res, fill=vpnteal!25, draw=vpnteal!75!black},
  gpu/.style={res, fill=gpupurple!25, draw=gpupurple!75!black, text width=14mm},
  store/.style={res, fill=storeyellow!25, draw=storeyellow!75!black}
]
...
\node[font=\scriptsize\bfseries, text=black!65] at (cloudA.north west)
  [anchor=north west, xshift=2mm, yshift=-2mm] {Cloud};
\node[vpc, minimum width=40mm, minimum height=50mm] (vpcA) at (cloudA.center) {};
\node[font=\scriptsize\bfseries, text=black!65] at (vpcA.north west)
...
\draw[arrow, color=apiorange!85!black] (apigwA) -- (k8sA);
\draw[arrow, color=gpupurple!85!black] (k8sA) -- (objA);

% ================== (B) HYBRID (Top Right) ==================
% On-Premise block (shifted left to create room for connection nodes)
\node[onprem] (premB) at (15mm, 22mm) {};
\node[font=\scriptsize\bfseries, text=black!65] at (premB.north west)
...
\node[font=\scriptsize\bfseries, text=black!65] at (cloudB.north west)
  [anchor=north west, xshift=2mm, yshift=-2mm] {Cloud};
\node[vpc, minimum width=40mm, minimum height=50mm] (vpcB) at (cloudB.center) {};
\node[font=\scriptsize\bfseries, text=black!65] at (vpcB.north west)
  [anchor=north west, xshift=2mm, yshift=-1.5mm] {VPC};
...
\draw[arrow, color=vpnteal!85!black] (k8sBprem.east) -- (vpnL.west);
\draw[arrow, color=vpnteal!85!black] (vpnR.east) -- (k8sBcloud.west);
\draw[arrowDashed, color=gray!65] (vpnL) -- (vpnR);
\draw[arrow, color=gpupurple!85!black] (k8sBprem) -- (vecB);
\draw[arrow, color=apiorange!85!black] (apigwB) -- (k8sBcloud);

% ================== (C) MULTI-CLUSTER (Bottom Center) ==================
\node[cloud, minimum width=95mm, minimum height=52mm] (cloudC) at (5mm, -65mm) {};
\node[font=\scriptsize\bfseries, text=black!65] at (cloudC.north west)
...
\node[font=\scriptsize\bfseries, text=black!65] at (vpcC1.north west)
...
\node[font=\scriptsize\bfseries, text=black!65] at (vpcC2.north west)
...
\draw[arrow, color=apiorange!85!black] (glbC.south west) ++(2mm,0) -- (k8sC1.north);
\draw[arrow, color=apiorange!85!black] (glbC.south east) ++(-2mm,0) -- (k8sC2.north);
\draw[arrowDashed, color=gray!65] (k8sC1) --
  node[font=\scriptsize\bfseries, align=center, midway, below=1mm, text=black!80]
  {failover} (k8sC2);

...
\renewcommand{\arraystretch}{1.3}
\rowcolors{2}{gray!5}{white}
\begin{tabularx}{\linewidth}{@{}>{\raggedright\arraybackslash}p{28mm}cccc@{}}
\toprule
\rowcolor{gray!10}
\textbf{Configuration} & \textbf{Monthly Cost} & \textbf{Throughput (tok/s)} & \textbf{TTFT P99} & \textbf{Cost/1M tokens} \\
\midrule

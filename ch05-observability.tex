...
\begin{lstlisting}[
  ...
  style=springerfloat,
  language=Python,
  caption={OpenTelemetry instrumentation for LLM inference, retrieval, and tool calls with proper span creation, attribute recording, and context propagation. Each function creates structured spans with LLM-specific attributes (token counts, latency breakdown, cost estimates, safety signals), enabling end-to-end tracing across multi-hop pipelines and precise attribution of latency and cost to individual pipeline stages.},

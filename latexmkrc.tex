# =========================================
# latexmkrc — Springer svmono (pdfLaTeX)
...
# 2) Shell-escape IS enabled to support the `minted` package (Pygments-based
#    syntax highlighting). This is an approved exception; no other external
#    compilers (knitr/asymptote/metapost/etc.) are used.

...
\begin{figure}[t]
  ...
  \begin{tikzpicture}[
    ...
    surface/.style={rectangle, draw=none, fill=llmblue!12, rounded corners=5pt, minimum width=24mm, minimum height=11mm, align=center, font=\small},
    threat/.style={rectangle, draw=none, fill=llmorange!12, rounded corners=5pt, minimum width=24mm, minimum height=9mm, align=center, font=\small},
    control/.style={rectangle, draw=none, fill=llmgreen!12, rounded corners=5pt, minimum width=24mm, minimum height=11mm, align=center, font=\small},
    crosscut/.style={rectangle, draw=none, fill=llmpurple!10, rounded corners=5pt, minimum width=120mm, minimum height=8mm, align=center, font=\footnotesize},
  ...
  \draw[-{Latex}, line width=1.2pt, color=llmblue!70!black] (input.east) -- (prompt.west);
  \draw[-{Latex}, line width=1.2pt, color=llmblue!70!black] (prompt.east) -- (retrieval.west);
  \draw[-{Latex}, line width=1.2pt, color=llmblue!70!black] (retrieval.east) -- (tools.west);
  \draw[-{Latex}, line width=1.2pt, color=llmblue!70!black] (tools.east) -- (output.west);
  ...
  \draw[-{Latex}, dashed, dash pattern=on 3pt off 2pt, line width=1pt, color=llmorange!60] (input.south) -- (inj.north);
  \draw[-{Latex}, dashed, dash pattern=on 3pt off 2pt, line width=1pt, color=llmorange!60] (prompt.south) -- (inj.north);
  \draw[-{Latex}, dashed, dash pattern=on 3pt off 2pt, line width=1pt, color=llmorange!60] (prompt.south) -- (bypass.north);
  \draw[-{Latex}, dashed, dash pattern=on 3pt off 2pt, line width=1pt, color=llmorange!60] (retrieval.south) -- (exfil.north);
  \draw[-{Latex}, dashed, dash pattern=on 3pt off 2pt, line width=1pt, color=llmorange!60] (tools.south) -- (misuse.north);
  \draw[-{Latex}, dashed, dash pattern=on 3pt off 2pt, line width=1pt, color=llmorange!60] (output.south) -- (leak.north);
  ...
  \draw[-{Latex}, line width=1.2pt, color=llmgreen!70!black] (inj.south) -- (sanitize.north);
  \draw[-{Latex}, line width=1.2pt, color=llmgreen!70!black] (bypass.south) -- (hierarchy.north);
  \draw[-{Latex}, line width=1.2pt, color=llmgreen!70!black] (exfil.south) -- (governance.north);
  \draw[-{Latex}, line width=1.2pt, color=llmgreen!70!black] (misuse.south) -- (toolsec.north);
  \draw[-{Latex}, line width=1.2pt, color=llmgreen!70!black] (leak.south) -- (outctrl.north);

  % Cross-cutting connections (dotted for distinction)
  \draw[-{Latex}, dotted, line width=1pt, color=llmpurple!60] ($(tracing.north west)!0.1!(tracing.north east)$) to[out=90,in=-90] (inj);
  \draw[-{Latex}, dotted, line width=1pt, color=llmpurple!60] ($(tracing.north west)!0.3!(tracing.north east)$) to[out=90,in=-90] (bypass);
  \draw[-{Latex}, dotted, line width=1pt, color=llmpurple!60] ($(tracing.north west)!0.5!(tracing.north east)$) to[out=90,in=-90] (exfil);
  \draw[-{Latex}, dotted, line width=1pt, color=llmpurple!60] ($(tracing.north west)!0.7!(tracing.north east)$) to[out=90,in=-90] (misuse);
  \draw[-{Latex}, dotted, line width=1pt, color=llmpurple!60] ($(tracing.north east)$) to[out=90,in=-90] (leak);
